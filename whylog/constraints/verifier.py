...
class Verifier(object):
    ...
    @classmethod
    def _verify_constraint(cls, combination, effect, idx, constraint, constraint_manager):
        """
        ...
        """
        constraint_verifier = constraint_manager.get_constraint_object(idx, constraint)
        groups = []
