...
class ConstraintRegistration(object):
    CONSTRAINTS = {
...
class ConstraintManager(object):
    ...
    def __getitem__(self, constraint_data):
        if not constraint_data['name'] in self._actual_constraints:
            constraint_verifier = ConstraintRegistration.get_constraint(constraint_data)
